...
- **소매/유통** — 평균 PSR: 0.3-0.8x, 특징: 박리다매, 낮은 마진
- **제조업** — 평균 PSR: 0.5-1.5x, 특징: 다양한 마진
- **기술** — 평균 PSR: 3-10x, 특징: 높은 성장성, 확장성
- **SaaS** — 평균 PSR: 5-15x+, 특징: 반복 매출, 높은 마진
- **바이오** — 평균 PSR: 10x+, 특징: 미래 매출 기대

## 활용 예시

### 성장기업 비교

- **쿠팡** — 매출 (억원): 30조, 시총 (억원): 30조, PSR: 1.0x, 매출성장률: 20%
- **토스** — 매출 (억원): 2조, 시총 (억원): 10조, PSR: 5.0x, 매출성장률: 50%
- **배민** — 매출 (억원): 3조, 시총 (억원): 15조, PSR: 5.0x, 매출성장률: 30%
...
- **Snowflake** — 성장률: 50%, 이익률: -10%, Rule of 40: 40
- **Salesforce** — 성장률: 20%, 이익률: 25%, Rule of 40: 45
- **일반 SaaS** — 성장률: 30%, 이익률: 5%, Rule of 40: 35
