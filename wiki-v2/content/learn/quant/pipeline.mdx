...
상세 내용은 [Walk-Forward 검증](/learn/quant-system/walk-forward) 참고.
...
- [리스크 관리](/learn/quant-system/risk-management): RiskGateway와 6모듈 상세
- [전략 프리셋](/learn/quant-system/strategies): 팩터 모델과 6종 전략
